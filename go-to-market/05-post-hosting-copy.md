...
**Demo URL:** https://totalrewardsaccelerator.com  
**Access:** open public demo (no password)  
**Loom URL:** _(paste after you record — see `04-loom-script.md`)_

---

## LinkedIn first comment (post immediately under primary post)
...
## DM reply when someone says PILOT

```
Great — design-partner pilots are fixed-scope (usually 4–6 weeks): clean → equity/flight risk → merit sandbox → optional offer closer, plus my support.

Standard package is $4,500 (early seats $3,000). I can send a 2-page SOW and a Calendly for kickoff.

Quick fit questions:
1) Approx employee population for the pilot?
2) Scrubbed file available, or sample-only first?
3) Primary goal: equity, merit process, offers, or all three?
```

---

## Loom description (paste under video)
...
## Calendar event name (15–20 min free demo)

`TRA walkthrough — Total Rewards Accelerator (sample data)`
